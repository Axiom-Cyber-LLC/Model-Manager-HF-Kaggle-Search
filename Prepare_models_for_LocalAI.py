...
def main() -> int:
    ap = build_parser('Prepare local GGUF models for LocalAI by symlinking them into a LocalAI models directory.', HOME / 'localai' / 'models')
    args = ap.parse_args()
    return run_linker('LocalAI', args.target, args, nested=False)
